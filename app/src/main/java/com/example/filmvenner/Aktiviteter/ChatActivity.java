...
public class ChatActivity extends AppCompatActivity implements RoomListener {
    ...
    //private String channelID = "jLPPh6rT9wZQD1pw";
    private String channelID = "jLPPh6rT9wZQD1pw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatMemberData data = new ChatMemberData (getRandomName(), getRandomColor());
    ...
    public void onMessage(Room room, com.scaledrone.lib.Message receivedMessage) {
        ...
        try {
            final ChatMemberData data = mapper.treeToValue(receivedMessage.getMember().getClientData(), ChatMemberData.class);
...
class ChatMemberData {
    ...
    public ChatMemberData(String name, String color) {
        this.name = name;
        this.color = color;
    }
